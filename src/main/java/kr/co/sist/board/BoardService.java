...
public class BoardService {
	...
	public String pagination(RangeDTO rDTO) {
		...
		prevMark.append("[ &lt;&lt; ]");
		/*prevMark.append("<li class='page-item'><a class='page-link' href='#'>Previous</a></li>");*/ //bootstrap
		if(rDTO.getCurrentPage() > pageNumber) {//시작페이지 번호가 3보다 크면
			movePage=startPage-1;// 4,5,6->3(시작번호1). 7,8,9->6(시작번호4).
