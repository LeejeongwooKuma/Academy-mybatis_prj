...
<link rel="shortcut icon" href="http://192.168.10.76/mybatis_prj/common/images/favicon2.ico"/>
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				...
				UrlVO[] urlArr={
						...
						new UrlVO("컬럼여러개에 한행 조회","day1224/mcsr"),
						new UrlVO("컬럼여러개에 여러행 조회","day1224/mcmr"),
						new UrlVO("like",""),
						new UrlVO("작다의 조회",""),
						new UrlVO("크다의 조회",""),
						new UrlVO("subquery",""),
