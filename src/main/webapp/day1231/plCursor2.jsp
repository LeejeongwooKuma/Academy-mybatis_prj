...
<td>
TimeStamp <fmt:formatDate value="${ md.inputDate }" pattern="yyyy-MM-dd EEEE kk:mm:ss"/>/
Date <fmt:formatDate value="${ md.input_date }" pattern="yyyy-MM-dd EEEE kk:mm:ss"/>
</td>
</tr>
</c:forEach>
</tbody>
